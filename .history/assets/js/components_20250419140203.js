...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const HotelComponents = {
        ...
        setupCustomCursor: function() {
            ...
            // Lista de seletores onde o cursor personalizado deve aparecer
            // CORREÇÃO: Adicionar footer e seus elementos explicitamente
            const cursorSelectors = [
                'body', 'main', 'header', 'section', 'div', 'button', 'a', 
                'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p', 'span', 'img',
                'footer', 'footer *', '.footer', '.footer *', // Adicionar footer explicitamente
            ...
            document.addEventListener('mousemove', (e) => {
                ...
                // CORREÇÃO: Verificar se o elemento sob o cursor deve ter o cursor personalizado
                const elementUnderCursor = document.elementFromPoint(e.clientX, e.clientY);
                const shouldShowCustomCursor = elementUnderCursor && 
                    (elementUnderCursor.matches(cursorSelectors) || elementUnderCursor.closest(cursorSelectors));
                ...
                if (shouldShowCustomCursor) {
                    ...
                    const isClickable = elementUnderCursor.matches(clickableElements) || elementUnderCursor.closest(clickableElements);
