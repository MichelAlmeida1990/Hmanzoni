    ...
    const HotelManzoni = {
        ...
        setupChatbot: function() {
            ...
            this.chatbotPatterns = [
                ...
                // Business Center e Trabalho
                {
                    patterns: ["business", "trabalho", "reunião", "reuniao", "escritório", "escritorio", "computador", "impressora"],
                    response: () => {
                        return `💼 **Business Center:**\n\n` +
                               `🖥️ **Computadores** disponíveis\n` +
                               `🖨️ **Impressora** e scanner\n` +
                               `📊 **Sala para pequenas reuniões**\n` +
                               `📶 **Internet de alta velocidade**\n` +
                               `📋 **Material de escritório**\n\n` +
                               `⏰ **Disponível**: 24 horas para hóspedes`;
                    }
                },

                // Lavanderia
                {
                    patterns: ["lavanderia", "lavar", "roupa", "limpeza", "secar"],
                    response: () => {
                        return `👕 **Serviço de Lavanderia:**\n\n` +
                               `⏰ **Entrega**: Mesmo dia (se enviado até 10h)\n` +
                               `🕐 **Horário**: Segunda a sábado, 8h às 18h\n` +
                               `💰 **Valores**: Consulte na recepção\n` +
                               `👔 **Tipos**: Lavagem, passadoria, limpeza a seco\n\n` +
                               `📋 **Procedimento**: Solicite na recepção`;
                    }
                },

                // Segurança
                {
                    patterns: ["segurança", "seguranca", "cofre", "seguro", "protegido"],
                    response: () => {
                        return `🔒 **Segurança do Hotel:**\n\n` +
                               `👮 **Recepção 24h** com equipe treinada\n` +
                               `📹 **Câmeras de segurança** nas áreas comuns\n` +
                               `🗝️ **Cofre na recepção** para valores\n` +
                               `🚗 **Estacionamento monitorado**\n` +
                               `🔐 **Controle de acesso** nos quartos\n\n` +
                ...
                // Formas de pagamento
                {
                    patterns: ["pagamento", "cartão", "cartao", "dinheiro", "pix", "débito", "debito", "crédito", "credito"],
                    response: () => {
                        return `💳 **Formas de Pagamento:**\n\n` +
                               ...
                               `🎁 **Promoção**: Pague com PIX e ganhe 5% de desconto!`;
                    }
                },

                // Acessibilidade
                {
                    patterns: ["acessibilidade", "cadeirante", "deficiente", "mobilidade", "rampa", "elevador"],
                    response: () => {
                        return `♿ **Acessibilidade:**\n\n` +
                               `🚪 **Quartos adaptados** disponíveis\n` +
                               `🛗 **Elevador** para todos os andares\n` +
                               `🚶 **Rampas de acesso**\n` +
                               `🚻 **Banheiros adaptados**\n` +
                               `🅿️ **Vagas preferenciais** no estacionamento\n\n` +
                               `💙 Informe suas necessidades na reserva!`;
                    }
                },

                // Turismo e atrações
                {
                    patterns: ["turismo", "atração", "atracao", "pontos turísticos", "turisticos", "o que fazer", "passeios"],
                    response: () => {
                        return `🗺️ **Pontos Turísticos Próximos:**\n\n` +
                               `🌳 **Parque das Nações** - 10 min\n` +
                               `🏛️ **Casa do Artesão** - 15 min\n` +
                               `🎭 **Teatro Glauce Rocha** - 12 min\n` +
                               `🏪 **Mercadão Municipal** - 8 min\n` +
                               `🏛️ **Museu Dom Bosco** - 20 min\n` +
                               `🛍️ **Shopping Campo Grande** - 10 min\n\n` +
                               `🚌 Nossa recepção pode ajudar com informações de transporte!`;
                    }
                },

                // Horário de funcionamento
                {
                    patterns: ["horário", "horario", "funciona", "abre", "fecha", "funcionamento"],
                    response: () => {
                        return `🕐 **Horários de Funcionamento:**\n\n` +
                               `🏨 **Recepção**: 24 horas\n` +
                               `☕ **Café da manhã**: 6h30 às 10h00\n` +
                               `💼 **Business center**: 24 horas\n` +
                               `👕 **Lavanderia**: Seg a Sáb, 8h às 18h\n` +
                               `🚗 **Estacionamento**: 24 horas\n\n` +
                               `💡 **Lembre-se**: Check-in 14h | Check-out 12h`;
                    }
                },

                // Promoções e descontos
                {
                    patterns: ["promoção", "promocao", "desconto", "oferta", "barato", "economia"],
                    response: () => {
                        return `🎉 **Promoções Especiais:**\n\n` +
                               `📱 **PIX**: 5% de desconto\n` +
                               `📅 **Estadia longa**: 7+ diárias = 10% off\n` +
                               `👨‍👩‍👧‍👦 **Crianças**: Até 12 anos não pagam\n` +
                               `🎂 **Aniversariante**: Desconto especial\n` +
                               `📧 **Newsletter**: Ofertas exclusivas\n\n` +
                               `💬 Entre em contato para conhecer nossas ofertas atuais!`;
                    }
                },

                // Transporte
                {
                    patterns: ["transporte", "táxi", "taxi", "uber", "ônibus", "onibus", "como chegar"],
                    response: () => {
                        return `🚗 **Opções de Transporte:**\n\n` +
                               `🚕 **Táxi**: Disponível 24h (recepção chama)\n` +
                               `📱 **Uber/99**: Região bem atendida\n` +
                               `🚌 **Ônibus**: Várias linhas próximas\n` +
                               `✈️ **Do Aeroporto**: 25 min de táxi/uber\n` +
                               `🚌 **Da Rodoviária**: 15 min de táxi\n\n` +
                               `🅿️ **Lembre-se**: Temos estacionamento gratuito!`;
                    }
                }
            ];
