    ...
    const HotelManzoni = {
        ...
        setupSidebar: function() {
            ...
            const openSidebar = () => {
                ...
                // Garantir que o body tenha as propriedades corretas apenas para mobile
                if (window.innerWidth <= 768) {
                    this.elements.body.style.overflow = 'hidden';
                    this.elements.body.style.position = 'fixed';
                    this.elements.body.style.width = '100%';
                    this.elements.body.style.top = '0';
            ...
            const closeSidebar = () => {
                ...
                setTimeout(() => {
                    ...
                    // Limpar completamente os estilos inline do body
                    this.elements.body.style.removeProperty('overflow');
                    this.elements.body.style.removeProperty('position');
                    this.elements.body.style.removeProperty('width');
                    this.elements.body.style.removeProperty('height');
                    this.elements.body.style.removeProperty('top');
                    this.elements.body.style.removeProperty('left');
                    
                    // Forçar reflow para garantir que as mudanças sejam aplicadas
                    this.elements.body.offsetHeight;
                    
                    // Atualizar acessibilidade
                    this.elements.mobileMenuToggle.setAttribute('aria-expanded', 'false');
                    
                    // Verificar se ainda há classes residuais
                    if (this.elements.body.classList.contains('sidebar-open')) {
                        this.elements.body.classList.remove('sidebar-open');
                    }
                }, 400);
            ...
            window.addEventListener('resize', () => {
                ...
                // Garantir que a responsividade seja mantida após redimensionamento
                setTimeout(() => {
                    if (this.elements.body.classList.contains('sidebar-open')) {
                        this.elements.body.classList.remove('sidebar-open');
                    }
