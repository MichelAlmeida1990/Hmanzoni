...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const HotelApp = {
        ...
        setupCustomCursor: function() {
            if (this.settings.isMobile) return; // Não aplicar em dispositivos móveis
            ...
            // Adicionar classe quando sobre elementos clicáveis
            const clickables = document.querySelectorAll('a, button, input, textarea, select, .room-card, .service-item, .gallery-item');
...
else if (messageLower.includes('endere
