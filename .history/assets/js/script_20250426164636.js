            ...
            function sendMessage() {
                ...
                setTimeout(() => {
                    ...
                    if (messageLower.includes('reserva') || messageLower.includes('quarto')) {
                        ...
                        botMessage.textContent = "Nossos preços variam de acordo com o tipo de quarto. Temos quartos a partir de R$120 a diária. Para um orçamento específico, informe a data e o tipo de quarto des
