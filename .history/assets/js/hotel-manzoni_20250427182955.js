...
(function() {
    ...
    const HotelManzoni = {
        ...
        setupChatbot: function() {
            // Alterado para usar a classe correta do HTML/CSS
        ...
        // Adicionar mensagem ao chatbot - CORRIGIDO
        addChatMessage: function(message, sender) {
            const chatbotMessages = document.querySelector('.chatbot-messages');
            if (!chatbotMessages) return;
            
            const messageElement = document.createElement('div');
            // Corrigido para usar as classes corretas do CSS
        ...
        // Adicionar indicador de digitação - CORRIGIDO
