        ...
        setupInteractiveMap: function() {
            ...
            if (mapContainer && typeof L !== 'undefined') {
                ...
                L.marker([hotelLat, hotelLng], { icon: hotelIcon })
                    .addTo(map)
                    .bindPopup('<strong>Hotel Manzoni</strong><br>Seu refúgio de luxo no coração da cidade')
                    .openPopup();
                
                // Adicionar pontos de interesse próximos
                const pointsOfInterest = [
                    { name: 'Shopping', lat: -20.469414, lng: -54.605804 },
                    { name: 'Mercado Municipal', lat: -20.481895, lng: -54.619499 },
                    { name: 'Praça Central', lat: -20.465231, lng: -54.618271 },
                    { name: 'Feira Central', lat: -20.472580, lng: -54.622308 }
                ];
