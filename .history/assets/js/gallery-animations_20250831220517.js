...
class GalleryAnimations {
    ...
    setup() {
        console.log('Inicializando GalleryAnimations...');
    ...
    loadAnimeJS() {
        if (typeof anime === 'undefined') {
            ...
            script.onerror = () => {
                console.error('Erro ao carregar Anime.js');
            };
            document.head.appendChild(script);
        } else {
            console.log('Anime.js já está carregado');
        }
    }
    ...
    applyGridLayout() {
        if (typeof anime === 'undefined') {
            console.log('Anime.js não está disponível, usando CSS transitions');
            this.applyGridLayoutCSS();
            return;
        }
...
// ===== INICIALIZAÇÃO =====
console.log('GalleryAnimations script carregado');
