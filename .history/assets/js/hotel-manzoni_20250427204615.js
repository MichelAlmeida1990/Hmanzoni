    ...
    const HotelManzoni = {
        ...
        processChatbotMessage: function(message) {
            ...
            const keywordResponses = {
                ...
                // Localização
                'localização': 'Estamos localizados na Av. Principal, 1000 - Centro, São Paulo, SP - CEP 01000-000.',
                'onde': 'O Hotel Manzoni fica na Av. Principal, 1000 - Centro, São Paulo, SP - CEP 01000-000.',
                'endereço': 'Nosso endereço é Av. Principal, 1000 - Centro, São Paulo, SP - CEP 01000-000.',
                'como chegar': 'Estamos localizados no centro de São Paulo, com fácil acesso a transporte público. Para mais informações, entre em contato conosco.',
            ...
            setTimeout(() => {
                ...
                if (!response) {
                    ...
                    // Perguntas sobre localização
                        ...
                        response = "Estamos localizados na Av. Principal, 1000 - Centro, São Paulo, SP - CEP 01000-000. Uma localização privilegiada próxima aos principais pontos comerciais e turísticos da cidade.";
                    }
        ...
        fetchAIResponse: function(message) {
            const payload = {
                inputs: `Você é um assistente virtual do Hotel Manzoni, um hotel em São Paulo. Responda de forma educada e prestativa. Pergunta do cliente: ${message}`,
                parameters: {
                    max_new_tokens: 100,
                    temperature: 0.7,
                    top_p: 0.9,
        ...
        setupInteractiveMap: function() {
            ...
            if (mapContainer && typeof L !== 'undefined') {
                // Coordenadas do hotel (São Paulo)
                ...
                L.marker([hotelLat, hotelLng], { icon: hotelIcon })
                    .addTo(map)
                    .bindPopup('<strong>Hotel Manzoni</strong><br>Conforto e simplicidade no centro de São Paulo')
                    .openPopup();
                
                // Adicionar pontos de interesse próximos
                const pointsOfInterest = [
                    { name: 'Shopping', lat: -23.546520, lng: -46.638308 },
                    { name: 'Mercado Municipal', lat: -23.542180, lng: -46.629870 },
                    { name: 'Praça Central', lat: -23.550120, lng: -46.636271 },
                    { name: 'Teatro Municipal', lat: -23.545580, lng: -46.638308 }
                ];
