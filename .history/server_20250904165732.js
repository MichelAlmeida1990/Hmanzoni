...
app.use(helmet({
    contentSecurityPolicy: {
        directives: {
            defaultSrc: ["'self'"],
            scriptSrc: ["'self'", "'unsafe-inline'", "https://s3-sa-east-1.amazonaws.com", "https://cdnjs.cloudflare.com"],
            styleSrc: ["'self'", "'unsafe-inline'", "https://fonts.googleapis.com", "https://cdnjs.cloudflare.com"],
            fontSrc: ["'self'", "https://fonts.gstatic.com", "https://cdnjs.cloudflare.com"],
            imgSrc: ["'self'", "data:", "https:"],
            connectSrc: ["'self'", "https://s3-sa-east-1.amazonaws.com"],
            frameSrc: ["'none'"],
            objectSrc: ["'none'"],
...
// Rota 404 para páginas do frontend
app.use('*', (req, res) => {
...
app.listen(PORT, () => {
    ...
    console.log(`   - Quartos: http://localhost:${PORT}/rooms`);
    console.log(`   - Galeria: http://localhost:${PORT}/gallery`);
    console.log(`   - Sobre: http://localhost:${PORT}/about`);
    console.log(`   - Contato: http://localhost:${PORT}/contact`);
});
